...
public class WeShareWebServer {
    ...
    private static String RATINGS_SERVER="http://localhost:8080";
    ...
    private static void claimRoutes() {
     ...
     private static void ratingsRoutes() {
         //path(RatingsController.PATH, () -> get(RatingsController::renderRatingsPage));
         System.out.println("attempting to set up");
         get(RatingsController.PATH, RatingsController::renderRatingsPage);
     }
    ...
    private void personRoute() {
        path(PersonController.PATH, () -> get(PersonController::renderPersons));
