...
public abstract class AbstractUserTest {
     ...
     */
    protected WeShareWebServer app = new WeShareWebServer();
    //might have to initialize this
    ...
    protected void navigateToListItem(String url_) {
        driver.findElement(By.id("list")).click();
        driver.findElement(By.id("claims")).click();
        assertThat(driver.getCurrentUrl()).isEqualToIgnoringCase(appUrl(url_));
    }

    protected void testTitle(String expectedUrl){
        assertThat(driver.findElement(By.id("title")).getText()).isEqualToIgnoringCase(expectedUrl);
