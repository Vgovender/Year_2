...
public class WeShareServer {
    ...
    private static void claimRoutes() {
        ...
        //get(ClaimExpenseController.PATH, NettExpensesController::renderHomePage);
        post(ClaimsApiController.PATH, ClaimsApiController::create);
    }

    private static void expenseRoutes() {
        path(CaptureExpenseController.CAPTURE_EXPENSE_PATH, () -> get(CaptureExpenseController::rendExpensePage));
        post(CaptureExpenseController.SUBMIT_EXPENSE_PATH, CaptureExpenseController::createExpense);
//        homePageRoute();
